...
const chapter4: TutorialChapter = {
  ...
  steps: [
    ...
    {
      id: 'project-print-view',
      rail: 'Print view',
      section: 'export',
      title: 'This is your estimate',
      body: 'Everything you have built across four chapters — check it exactly as the sanctioning office will see it.',
      primary: 'Opened it',
      screen: 'the project dashboard',
    ...
    },
    {
      ...
      rail: 'All of it',
      section: 'export',
      title: 'Cover, abstract, signatures — all of it',
      body: 'The miscellaneous line sits in the abstract, and the signatures print where you told them to.',
      primary: 'Next — export it',
      screen: 'the project print view'
    },
    {
      id: 'file-export',
      actionLabel: 'File in the menu bar',
      rail: 'File',
      section: 'export',
      title: 'Export lives under File',
      body: 'Save keeps the project file; Export turns it into the PDF you hand over.',
      primary: 'Opened the menu',
      screen: 'the menu bar',
      target: { selector: '[data-tour="menu-file"]', placement: 'bottom' }
    },
    {
      id: 'hover-export',
      actionLabel: 'Export',
      ...
      section: 'export',
      title: 'Hover Export',
      body: 'The submenu opens on hover — no click needed.',
      primary: 'Opened it',
      screen: 'the File menu',
      target: { selector: '[data-tour="menu-export"]', placement: 'right' }
    },
    {
      id: 'export-pdf',
      rail: 'PDF',
      section: 'export',
      title: 'PDF',
      body: 'The same format the sanctioning office expects.',
      primary: 'Export PDF',
      screen: 'the File ▸ Export submenu',
      target: { selector: '[data-tour="menu-export-pdf"]', placement: 'right' }
    },
    {
      id: 'rendering',
      rail: 'Rendering',
      ...
      body:
        'Cover, abstract, components, lead, seigniorage, signatures — each one rendered and collated into a ' +
        'single file. The list ticks off as it goes.',
      primary: 'Wait for it',
      screen: 'the Export PDF dialog'
    },
    {
      id: 'saved',
      rail: 'Saved',
      section: 'export',
      title: 'A finished PDF on disk',
      body: 'That file is what goes to the sanctioning authority. Close the dialog when you have it.',
      primary: 'Closed it',
      screen: 'the Export PDF dialog'
    },
    {
